<footer class="mx-auto mt-auto w-full max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8" id="kutton">
	<!-- Grid -->
	<div class="grid grid-cols-1 items-center gap-5 md:grid-cols-3">
		<div>
			<a
				class="flex-none py-5 text-xs font-semibold text-gray-500 focus:outline-none dark:text-white"
				href="/"
				aria-label="Brand">© 2024 United Nations Development Programme.</a
			>
		</div>
		<!-- End Col -->
